function toggleForm(type, event) {
  ...
  if (type === "signup") {
    ...
    text.innerHTML = `Already have an account? <a href="#" onclick="toggleForm('login', event)">Login</a>`;
  } else {
    form.setAttribute("action", "process/login_process.php");
    button.textContent = "Login";
    nameField.style.display = "none";
    rememberField.style.display = "flex";
    text.innerHTML = `Doesn't have an account? <a href="#" onclick="toggleForm('signup', event)">Sign up</a>`;
  }
}
